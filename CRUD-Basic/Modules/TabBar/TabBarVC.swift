...
//        tabBar.layer.backgroundColor = Colors.background.cgColor
    ...
    func setupVCs() {
        viewControllers = [
            createNavController(for: DiscoveriesRouter().createModule(), title: NSLocalizedString("Library", comment: ""), image: UIImage(systemName: "book")!),
            createNavController(for: FavoritesRouter().createModule(), title: NSLocalizedString("Favorite", comment: ""), image: UIImage(systemName: "bookmark")!)
        ]
    }
